...
namespace Implementation.UseCases
{
    public class UseCaseHandler
    {
        ...
        //PRIVREMENO - 34,35,36,38,37(MyGuestBookings),39 (AddToFavorite)
        private List<int> GloballyAllowed = new List<int> { 2, 3, 6, 4, 15, 16, 25,26,27,28,29,32,34,35,36,38,37,39 };
